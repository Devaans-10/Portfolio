...
export default function Footer() {
  return (
    <footer className="w-full bg-transparent py-8 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-gray-500 text-sm font-mono text-center">
          &copy; 2024 Devaans. All rights reserved.
        </div>
        
        <div className="flex gap-6 items-center">
          <a 
            href="https://github.com/Devaans-10" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-[var(--color-neon-pink)] transition-colors flex items-center gap-2"
          >
          ...
          <a 
            ...
            className="text-gray-400 hover:text-[var(--color-neon-blue)] transition-colors flex items-center gap-2"
          >
